...
剪去子树：变成占比高的叶子节点标签
#### 4.4.5.2 最小化子树损失函数
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml18.png?raw=true)
# 5 集成学习
## 5.1 原理
多个分类器集成在一起以提高分类准确率
集成方法包括多数投票法等等
...
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml19.png?raw=true)
### 5.1.3 基本策略
#### 5.1.3.1 回归问题
...
### 5.2.1 基本原理
有放回的采样方法
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml20.png?raw=true)
### 5.2.2 优点&缺点
【优点】
...
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml21.png?raw=true)
【特点】
...
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml22.png?raw=true)
【可视化表现】
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml23.png?raw=true)
#### 5.3.2.3 解释
##### 5.3.2.3.1 加法模型
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml24.png?raw=true)
损失函数可以写作$L(y_i,f(x))$，f(x)为上述表达式，这个函数优化起来十分复杂，可以采用前向分步算法
##### 5.3.2.3.2 前向分步算法
每一步只学习一个基函数及其系数
![](https://github.com/AliceRayLu/AliceRayLu.github.io/blob/main/source/_posts/knowledge/machine%20learning/assets/ml25.png?raw=true)
